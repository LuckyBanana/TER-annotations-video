...
public class HttpClientAsync {
	...
	public void postVideoData(final Video donnees) throws IOException {
		new AsyncTask() {
			...
			protected Object doInBackground(Object... params) {
				...
				try {
					HttpClient.post("api/video", donnees, 2);
				} catch (IOException e) {
	...
	public void postVideoStream(final Video donnees) throws IOException {
		new AsyncTask() {
			...
			protected Object doInBackground(Object... params) {
				// TODO Auto-generated method stub
				try {
					HttpClient.post("api/video/id="+donnees.getId(), donnees, 1);
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
